  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <motion.div 
        ...
        exit={{ opacity: 0 }}
        onClick={onClose}
        className="absolute inset-0 bg-[#0a1128]/90 backdrop-blur-lg"
      />
      ...
      <motion.div 
        ...
        className="relative bg-white w-full max-w-6xl max-h-[95vh] rounded-sm overflow-hidden shadow-2xl flex flex-col md:flex-row z-10"
      >
        <button 
          onClick={onClose}
        ...
        <div className="md:w-1/2 relative h-80 md:h-auto group">
          <img 
          ...
          <div className="absolute bottom-12 left-12 right-12 text-white">
            <span className="border border-[#c5a059] text-[#c5a059] px-6 py-2 rounded-sm text-[10px] font-black uppercase tracking-[0.4em] mb-6 inline-block">
              {property.type}
            </span>
            <h2 className="text-5xl font-black mb-4 uppercase tracking-[0.05em] leading-tight">{property.title}</h2>
        ...
        <div className="md:w-1/2 overflow-y-auto p-16 bg-white">
          <div className="flex justify-between items-center mb-14 pb-14 border-b border-slate-100">
            <div>
              ...
              <p className="text-6xl font-black text-[#0a1128] tracking-tighter">${property.price.toLocaleString()}</p>
            </div>
          </div>
          ...
          <div className="space-y-16">
            ...
            <section>
              <h3 className="text-[11px] font-black text-slate-900 uppercase tracking-[0.4em] mb-8 border-l-4 border-[#c5a059] pl-6">Specifications</h3>
              <div className="grid grid-cols-2 gap-6">
                {property.features.map((f, i) => (
                  <div key={i} className="flex items-center gap-4 text-slate-800 bg-slate-50 p-6 border border-slate-100">
            ...
            <section className="p-10 bg-[#0a1128] text-white rounded-sm shadow-2xl">
              <h3 className="text-[11px] font-black text-[#c5a059] uppercase tracking-[0.4em] mb-8">Expert Profile</h3>
              ...
              <button className="text-[10px] font-black uppercase tracking-[0.4em] text-[#c5a059] hover:text-white transition-all underline underline-offset-8">Request Detailed Market Brief</button>
            </section>
            ...
            <div className="flex gap-6 pt-12 border-t border-slate-100">
              <button className="flex-[2] bg-[#0a1128] text-white font-black py-6 rounded-sm hover:bg-[#c5a059] hover:text-[#0a1128] transition-all uppercase tracking-[0.4em] text-[10px] shadow-2xl shadow-[#0a1128]/20">Request Confidential Tour</button>
              <button className="flex-1 border-2 border-slate-200 text-slate-900 font-black rounded-sm hover:border-[#0a1128] transition-all uppercase tracking-[0.3em] text-[10px]">E-Mail Associate</button>
            </div>
          </div>
        </div>
      </motion.div>
