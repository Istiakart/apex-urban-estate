...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a1128]/95 backdrop-blur-md border-b border-amber-900/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          <div className="flex items-center gap-5">
            <div className="w-12 h-12 flex items-center justify-center">
              <svg viewBox="0 0 40 40" className="w-full h-full text-[#c5a059]" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M6 36H34" stroke="currentColor" strokeWidth="2"/>
              </svg>
            </div>
          ...
          <div className="hidden md:flex items-center space-x-12">
            {['Properties', 'Advisory', 'Market Expertise', 'About Us'].map((item) => (
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-[#0a1128] border-t border-amber-900/10 p-8 animate-in fade-in slide-in-from-top duration-300">
